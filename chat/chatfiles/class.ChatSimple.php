...
class ChatSimple {
  ...
  public function chatRooms() {
    ...
    else $chatrooms = '<span><b> &nbsp; &nbsp; - Chat</b></span>';
    ...
    if(file_exists($this->fileroom)) {
      ...
      if(isset($_POST['adchat'])) {
        ...
        if(strlen($adchat)<1 || strlen($adchat)<201) {
          $chatrows[] = '<p><span class="chatusr">&bull; '.$this->chatuser.'  </span><em>'.$chatdate.'</em><span class="chat"> '. $this->formatBbcode($adchat). '</span></p>';
  ...
  protected function formatBbcode($str) {
    ...
    '<img class="c" src="chatex/0.gif" alt=":)" />',
    '<img class="c" src="chatex/1.gif" alt=":(" />',
    '<img class="c" src="chatex/2.gif" alt=":P" />',
    '<img class="c" src="chatex/3.gif" alt=":D" />',
    '<img class="c" src="chatex/4.gif" alt=":S" />',
    '<img class="c" src="chatex/5.gif" alt=":O" />',
    '<img class="c" src="chatex/6.gif" alt=":=)" />',
    '<img class="c" src="chatex/7.gif" alt=":|H" />',
    '<img class="c" src="chatex/8.gif" alt=":X" />',
    '<img class="c" src="chatex/9.gif" alt=":-*" />'
    );
